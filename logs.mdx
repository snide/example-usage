...
You will need have a rough understanding of how Elastic works, and have the Stack running. [A trial account](/blah) will be sufficient for this exercise, and should only take three minutes to set up.
